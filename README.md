...
Please note that that the purpose of this script is to reshape windows that have been manually moved to a screen corner with the default KWin stacking window management system; Tile Gaps is not a tiling window manager and does not do any automatic tiling.
